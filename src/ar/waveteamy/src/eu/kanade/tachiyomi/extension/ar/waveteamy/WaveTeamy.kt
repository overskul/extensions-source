...
class WaveTeamy : ParsedHttpSource(), ConfigurableSource {
    ...
    private val defaultBaseUrl = "https://waveteamy.com"
    ...
    override fun latestUpdatesSelector() = "body > div.bnContainer > div > div"
    ...
    override fun latestUpdatesFromElement(element: Element): SManga {
        return SManga.create().apply {
            ...
            thumbnail_url = linkElement.first()!!.select("img").first()!!.absUrl("src")
        }
    }
